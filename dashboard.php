...
<html>
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-5 mb-4">
            <div class="card border-bottom-info shadow h-100 pb-2">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-uppercase">Pengunjung Bulan ini </h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-3 col-lg-5 mb-4">
            <div class="card border-bottom-primary shadow h-100 pb-2">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-uppercase">Batas Pengunjung Per Hari</h6>
                </div>
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
